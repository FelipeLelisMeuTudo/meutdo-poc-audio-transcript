...
""" TODO: O contexto pode ser autalizado na função handle_realtime_connection no evneto session:update,
    Cada sessão segue um contexto, podemos compartilhar contexto para perfilar e especializar o modelo para
    trabalhar como um agente na meutudo"""
